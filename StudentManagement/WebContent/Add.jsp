...
<body>
  ...
  <form action="Add1.jsp" onsubmit ="return validate()" method="post">
  <h2 style = "font-family:Heiti SC;color:white;font-size:20px">输入要增加的学生学号</h2>
  <input  type="text" name="id" id ="id">
  <h2 style = "font-family:Heiti SC;color:white;font-size:20px">输入要增加的学生名称</h2>
